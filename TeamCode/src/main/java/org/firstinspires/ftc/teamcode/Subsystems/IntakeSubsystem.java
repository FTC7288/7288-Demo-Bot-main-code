...
public class IntakeSubsystem extends SubsystemBase {
    ...
    // note full speed of intake motor is ~6,000rpm = 100rps

    // f and p gain units in mtr power/(rps)
    private double fgain = 0.01;    // note: ideal no-load f-gain is 0.01
    private double pgain = 0.007;
    ...
    public void periodic() {
        ...
        //PanelsTelemetry.INSTANCE.getFtcTelemetry().addData("IntakeSpeed", CurrentSpeed);
        //PanelsTelemetry.INSTANCE.getFtcTelemetry().addData("Target", TargetSpeed);
